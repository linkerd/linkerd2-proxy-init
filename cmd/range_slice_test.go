...
func TestMapRangeSlice(t *testing.T) {
	assertRangesEqual(t, []string{"23"}, []int{23})
	assertRangesEqual(t, []string{"23-23"}, []int{23})
	assertRangesEqual(t, []string{"23", "25"}, []int{23, 25})
	assertRangesEqual(t, []string{"25-27"}, []int{25, 26, 27})
	assertRangesEqual(t, []string{"20-21", "25-27"}, []int{20, 21, 25, 26, 27})
	// Note that the slice is NOT sorted!
	assertRangesEqual(t, []string{"25-27", "17"}, []int{25, 26, 27, 17})
}
...
func assertRangesEqual(t *testing.T, test []string, expected []int) {
	var check []int
